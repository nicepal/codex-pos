...
const createProductSchema = Joi.object({
  ...
  product_type: Joi.string().valid('simple', 'variable', 'bundle', 'service', 'digital').optional(),
  is_open_price: Joi.boolean().optional(),
  tax_rule_id: Joi.string().uuid().allow(null).optional(),
  tracks_serials: Joi.boolean().optional(),
  tracks_batches: Joi.boolean().optional(),
