...
async function seedDummyData() {
  ...
  for (let i = 1; i <= 50; i++) {
    ...
    const email = `owner${num}@seed.codexpos.store`;
  ...
  logger.info('Example logins: owner01@seed.codexpos.store ... owner50@seed.codexpos.store');
}
