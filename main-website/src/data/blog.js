export const blogPosts = [
  {
    ...
    tags: ['POS', 'Inventory'],
    body: [
      'When checkout and stock live in separate tools, every return and transfer becomes a manual patch. PosHive keeps POS orders and inventory movements in the same tenant database with strict tenant_id isolation.',
  ...
  },
  {
    ...
    body: [
      'Growing from one store to three usually breaks ad-hoc stock sheets first. PosHive models branches as first-class entities with plan limits (1 / 3 / unlimited).',
  ...
  },
  {
    ...
    excerpt: 'Use PosHive’s GraphQL bulk import and worker pipeline instead of hand-copying SKUs.',
    date: '2026-07-10',
    readMinutes: 4,
    tags: ['Shopify', 'Integrations'],
    body: [
      'Catalog migrations fail when they depend on heroic CSV editing. PosHive’s Shopify integration runs bulk GraphQL ops through BullMQ with mapping tables and progress UI.',
      'Treat it as an import pipeline — not a promise of full bi-directional commerce sync on day one.',
      'After import, sell through PosHive POS and optional storefront while keeping Shopify as an upstream catalog source.',
    ],
  },
  {
    slug: 'ai-reorder-insights',
    title: 'AI reorder insights: assistive, not autonomous',
    excerpt: 'How PosHive frames AI suggestions so operators stay in control.',
    date: '2026-07-22',
    readMinutes: 5,
    tags: ['AI', 'Analytics'],
    body: [
      'AI Pro unlocks forecasting-style assistance and content helpers — but PosHive labels insights as examples and decision support.',
  ...
  },
  {
    ...
    title: 'Extend PosHive with API keys and webhooks',
